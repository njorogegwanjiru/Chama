...
class _MakePaymentState extends State<MakePayment> {
  ...
  final contributionOrProjectController = TextEditingController();
  ...
  void dispose() {
    ...
    paymentAmountController.dispose();
    transactionAmountController.dispose();
    contributionOrProjectController.dispose();
  }
  ...
  Widget monthItem(String monthName) {
    return InkWell(
      onTap: () {
        Navigator.pop(context);
        contributionOrProjectController.value = TextEditingValue(
            text: monthName + "_" + DateTime.now().year.toString());
      },
      child: Padding(
        padding: EdgeInsets.all(8),
  ...
  Widget panelHeader(String label, function, Color color) {
    return InkWell(
      onTap: function,
    ...
    return Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
      children: [
        panelHeader(
          ...
          },moneyIn?Colors.white: Colors.grey.shade100
        ),
        panelHeader(
          "Record Money out ⤴",
              () {
          ...
          },moneyIn?Colors.grey.shade100: Colors.white
        ),
      ],
    );
  }
  ...
  Widget panelBody() {
    return Column(
      children: [
        moneyIn ? moneyInCard() : moneyOutCard(),
        moneyIn ? moneyInDataTable() : moneyOutDataTable(),
      ],
    );
  }
                ...
                children: [
                  isMonthly
                      ? GestureDetector(
                          ...
                          child: AbsorbPointer(
                            child: TextFormField(
                              controller: contributionOrProjectController,
                              onChanged: (value) {},
                              decoration: InputDecoration(
                                labelText: 'Month',
                              ),
                                ...
                                onTap: () {
                                  API()
                                    ...
                                    API().recordPaymentAndTransaction(
                                        ...
                                        contributionOrProjectController.text.toString(),
                                        _memberName,
                                        "Payment",
                                        DateTime.now().day.toString() +
                                            '/' +
                                    ...
                                    setState(() {
                                      ...
                                      contributionOrProjectController.text='';
                                      statistics = API().getStatistics();
                                    });
                                    CoolAlert.show(
            ...
            ButtonTheme(
              ...
              child: RaisedButton(
                ...
                onPressed: () {
                  ...
                  setState(() {
                    newCashInAcc = cashInAcc -
                        int.parse(transactionAmountController.text.toString());
    ...
    return Container(
      ...
      child: DataTable(columns: [
        ...
        DataRow(
          cells: [
            DataCell(Text('Spent Cash')),
            DataCell(Text(transactionCosts.toStringAsFixed(2))),
          ],
        ),
        DataRow(
          cells: [
            ...
            builder: (BuildContext context, AsyncSnapshot<List<Project>>snapshot){
              if (snapshot.hasData) {
                ...
                if(_projects.isEmpty){
                  return Center(
                  child: Text("Register A project first...🙂🙂"),
                );
                }else{
                  return ListView.separated(
                    ...
                    itemBuilder: (BuildContext context, int index){
                      return Container(
                        child: ListTile(
                          title: Text(
                              'Project : ' + '${_projects[index].projectName}'),
                          onTap: () {
                            setState(() {
                              contributionOrProjectController.value =
                                  TextEditingValue(text: _projects[index].projectName);
                              projectId = _projects[index].projectId;
                            });
                            Navigator.pop(context);
                          },
                        ),
